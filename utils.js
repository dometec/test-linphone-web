	...
	var config = {
		...
		files: {
			'Windows' : {
				'x86' : {
					'Explorer' : {
						file: 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Linux-x86.xpi',
						icon: 'style/img/linphone.ico'
					},
					'DEFAULT' : 'linphone-web-1.0.8-4-ge18797d-Win32.msi'
				},
				'x86_64' : {
					'Explorer' : {
						file: 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Linux-x86.xpi',
					...
					'DEFAULT' : 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Win32.msi'
				}
			},
			'Linux' : {
				'x86' : {
					...
					'DEFAULT' : 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Linux-x86.tar.gz'
				}, 
				'x86_64' : {
					'Firefox' : {
						file: 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Linux-x86_64.xpi',
						icon: 'style/img/linphone.ico'
					},
					'DEFAULT' : 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Linux-x86_64.tar.gz'
				}
			},
			'Mac' : {
				'x86' : {
					'Firefox' : {
						file: 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Mac-x86.xpi',
						icon: 'style/img/linphone.ico'
					},
					'DEFAULT' : 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Mac-x86.pkg'
				}, 
				'x86_64' : {
					'Firefox' : {
						file: 'http://web_NO_.linphone.org/downloads/linphone-web-' + version + '-Mac-x86.xpi',
