...
if (typeof linphone == "undefined" || !linphone) 
	var linphone = {};
...
linphone.CallState = {
	...
	PausedByRemote : 14,
	/**
	 * The call's parameters change is requested by remote end, used for example
	 * when video is added by remote
	 * 
	 */
	UpdatedByRemote : 15,
	/**
...
linphone.PresenceActivityType = {
	/**
	 * This value is not defined in the RFC, it corresponds to no activity with
	 * a basic status of "closed".
	 */
	Offline : 0,
	/**
	 * This value is not defined in the RFC, it corresponds to no activity with
	...
	Online : 1,
	/**
	 * The person has a calendar appointment, without specifying exactly of what
	 * type. This activity is indicated if more detailed information is not
	 * available or the person chooses not to reveal more information.
	 */
	Appointment : 2,
	/**
	...
	Away : 3,
	/**
	 * The person is eating the first meal of the day, usually eaten in the
	 * morning.
	 */
	Breakfast : 4,
	/**
	...
	Busy : 5,
	/**
	 * The person is having his or her main meal of the day, eaten in the
	...
	Lunch : 10,
	/**
	 * The person is scheduled for a meal, without specifying whether it is
	 * breakfast, lunch, or dinner, or some other meal.
	 */
	Meal : 11,
	/**
	 * The person is in an assembly or gathering of people, as for a business,
	 * social, or religious purpose. A meeting is a sub-class of an appointment.
	 */
	Meeting : 12,
	/**
	...
	OnThePhone : 13,
	/**
	 * The person is engaged in an activity with no defined representation. A
	 * string describing the activity in plain text SHOULD be provided.
	 */
	Other : 14,
	/**
	 * A performance is a sub-class of an appointment and includes musical,
	 * theatrical, and cinematic performances as well as lectures. It is
	 * distinguished from a meeting by the fact that the person may either be
	...
	Performance : 15,
	/**
	 * The person will not return for the foreseeable future, e.g., because it
	...
	Playing : 17,
	/**
	 * The person is giving a presentation, lecture, or participating in a
	...
	Steering : 22,
	/**
	 * The person is on a business or personal trip, but not necessarily
	 * in-transit.
	 */
	Travel : 23,
	/**
	...
	Vacation : 26,
	/**
	 * The person is engaged in, typically paid, labor, as part of a profession
	 * or job.
	 */
	Working : 27,
	/**
...
linphone.PresenceBasicStatus = {
	...
	Open : 0,
	/**
	 * This value means that the associated contact element, if any, is unable
...
linphone.Privacy = {
	...
	None : 0,
	/**
	 * Request that privacy services provide a user-level privacy function. With
	 * this mode, "from" header is hidden, usually replaced by From: "Anonymous"
	 * <sip:
	 */
	User : 1,
	/**
	 * Request that privacy services modify headers that cannot be set
	...
	Session : 3,
	/**
	 * rfc3325 The presence of this privacy type in a Privacy header field
	 * indicates that the user would like the Network Asserted Identity to be
	 * kept private with respect to SIP entities outside the Trust Domain with
	 * which the user authenticated. Note that a user requesting multiple types
	 * of privacy MUST include all of the requested privacy types in its Privacy
	 * header field value
	 */
	Id : 4,
	/**
	...
	Critical : 5,
	/**
	 * Special keyword to use privacy as defined either globally or by proxy
	 * using
	 */
	Default : 6
};
...
linphone.IceState = {
	...
	HostConnection : 3,
	/**
	 * ICE has established a connection to the remote host through one or
	 * several NATs
	 */
